<%@ Page Title="" Language="C#" MasterPageFile="~/logcustomer/MasterCustomer.Master" AutoEventWireup="true" CodeBehind="Blog.aspx.cs" Inherits="SpecialCoffe.logcustomer.Blog"  enableEventValidation="false" validateRequest="false" %>
					...
					<div class="rightbar">
						...
						<ul>
							<li class="p-t-6 p-b-8 bo6">
								<a href="Shop.aspx" class="s-text13 p-t-5 p-b-5">
									Especial Clásico 
								</a>
							</li>
