...
{
    public partial class logueoVendedor : System.Web.UI.Page
    {
		...
		protected void btnRegistrarme_Click(object sender, EventArgs e)
		{
			...
			conectar.Open();
			Def.comando = new SqlCommand("sp_insertar_buyers", conectar);
			...
			SqlParameter inserNomEm = new SqlParameter();
			inserNomEm.ParameterName = "@nombreEmpresa";
			inserNomEm.SqlDbType = SqlDbType.VarChar;
			inserNomEm.Value = txtNombreEmpresa.Text;

			SqlParameter insertpais = new SqlParameter();
			insertpais.ParameterName = "@pais";
			insertpais.SqlDbType = SqlDbType.VarChar;
			insertpais.Value = txtPais.Text;
			...
			Def.comando.Parameters.Add(inserNomEm);
			Def.comando.Parameters.Add(insertpais);
